...
class StorySalonDataset(Dataset):
    def __init__(self, root, dataset_name):
        ...
        # self.video_image_dir = os.path.join("./StorySalon/", 'Image_inpainted')
        # self.video_mask_dir = os.path.join("./StorySalon/", 'Mask')
        # self.video_text_dir = os.path.join(self.root, 'Text', 'Caption')
        ...
        # In-house data
        # self.pdf_image_dir = os.path.join("/data/home/haoningwu/Dataset/StorySalon/", 'StoryBook_finally_checked', 'image_inpainted')
